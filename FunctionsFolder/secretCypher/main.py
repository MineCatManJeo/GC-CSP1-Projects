    ...
    for x in text: # once for EVERY letter in the string
        if x.isalpha(): # checks if it is in the alphabet
            if x.islower(): # checks for lovercase
                ch = ord(x) + (int(shift%26)) # if it is, shift it
